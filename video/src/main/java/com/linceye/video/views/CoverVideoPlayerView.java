package com.linceye.video.views;
...
public class CoverVideoPlayerView extends StandardGSYVideoPlayer {
    ...
    public int getLayoutId() {
        return R.layout.cover_video_layout;
    }
     ...
     * 是否缓存
     */
    public void setVideoCache(boolean cache){ mCache = cache; }

    /**
     * 设置title
     */
    public void setVideoTitle(String title){ mTitle = title; }

    /**
     * 保存播放状态
     */
    public CoverVideoPlayerView saveState(){
        CoverVideoPlayerView switchVideo = new CoverVideoPlayerView(getContext());
    ...
    public GSYBaseVideoPlayer showSmallVideo(Point size, boolean actionBar, boolean statusBar) {
        CoverVideoPlayerView sampleCoverVideo
                = (CoverVideoPlayerView) super.showSmallVideo(size, actionBar, statusBar);
    ...
    protected void clearFullscreenLayout() {
        ...
        final ViewGroup viewGroup = (CommonUtil.scanForActivity(getContext()))
                .findViewById(Window.ID_ANDROID_CONTENT);
        final View oldF = viewGroup.findViewById(getFullId());
        if (oldF != null){
