package com.linc.linceye.mvvm.player.bean;
 ...
 * @since 2020-02-21
 */
public class VideoHeaderBean extends BaseCustomViewModel implements Parcelable
{
    ...
    @Override
    public int type() {
        return IVideoItemType.VIDEO_DESCRIPTION;
    }
}
