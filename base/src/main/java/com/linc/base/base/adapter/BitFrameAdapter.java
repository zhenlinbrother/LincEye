package com.linc.base.base.adapter;
 ...
 * @since [产品/模块版本]
 */
public class BitFrameAdapter extends LRefreshAndLoadMoreAdapter {
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    ...
                    if (itemViewType == RETRY_TYPE ||
                            ...
                            itemViewType == LRecyclerConfig.FOOT ||
                            itemViewType == LRecyclerConfig.HEAD) {
